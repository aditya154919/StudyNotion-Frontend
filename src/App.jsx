...
import LiveStream from "./components/cores/LiveStream/streamForm";
import LiveDashboard from "./components/cores/LiveStream/LiveDashboard";
import LiveRoom from "./components/cores/LiveStream/LiveRoom";
import LiveStudentRoom from "./pages/LiveRoom";
import Analytic from "./components/cores/LiveStream/Analytic";
    ...
    <div className="w-screen min-h-screen bg-[#000814] flex flex-col font-inter">
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/live-room/:roomId/:streamId/:sectionId" element={<LiveRoom />} />
          ...
          {user?.accountType === ACCOUNT_TYPE.INSTRUCTOR && (
            <>
              ...
              <Route
                ...
                element={<Edit />}
              />
              <Route path="/dashboard/livestream" element={<LiveStream />} />
              <Route
                path="/dashboard/live-dashboard/:streamId"
                element={<LiveDashboard />}
              />
              <Route path="/dashboard/live-Analytic" element={<Analytic/>}/>
            </>
          )}
          ...
          {user?.accountType === ACCOUNT_TYPE.STUDENT && (
            <>
              ...
              <Route path="/dashboard/LiveRoom" element={<LiveStudentRoom />} />
            </>
          )}
        </Route>
